...
Result: garbage CJK characters from perfectly normal ASCII symbol names. Before the v1.0.8 fix, NeoDAX produced 85 false positives on a simple `/bin/ls` analysis.

### v1.0.8 Fixes - Seven Layers of Defense
