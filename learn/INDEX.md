...
70 files. 8 levels. Start at `00` and work forward.

> **License:** Apache 2.0 - see `LICENSE` in the repository root.
> **Version:** NeoDAX 1.1.1
...
| 02_setting_up_neodax.md | Installation on Linux, macOS, Android/Termux |
...
| 26_switch_tables.md | Switch/dispatch table detection |
| 27_unicode_strings.md | Unicode string extraction (UTF-8, UTF-16) |
| 28_instruction_groups.md | Instruction group classification |
...
| 31_loading_binaries_in_js.md | Load patterns and NeoDAXBinary lifecycle |
...
| 41_packed_binary_detection.md | Detecting packed and encrypted binaries |
| 42_recursive_descent.md | Recursive descent disassembly |
| 43_instruction_validity_filter.md | IVF for obfuscation and suspicious patterns |
| 44_hottest_functions.md | Most-called function analysis |
| 45_obfuscation_detection.md | Detecting obfuscation — IVF, poly map, DSA, AIRE |
| 46_symbol_demangling.md | C++ Itanium ABI name demangling |

## Level 5 - Symbolic Execution and Decompilation (files 50-56)

| File | Topic |
|------|-------|
| 50_symbolic_execution_intro.md | What symbolic execution is |
| 51_ssa_lifting.md | NR — NeoDAX Representation (inter-function IR, type system) |
| 52_decompiler_output.md | Pseudo-C decompiler — type inference, resolved calls, program module |
| 53_reading_pseudo_c.md | Reading and interpreting pseudo-C |
| 54_arm64_emulator.md | The concrete ARM64 + RISC-V execution engine |
| 55_emulator_use_cases.md | Practical emulator applications |
| 56_dsa_analysis.md | DSA — Dynamic Single Assignment (runtime value annotation) |
...
| 63_reverse_engineering_protocols.md | Understanding custom binary protocols |
...
| 66_daxc_snapshots.md | AOT C snapshots - create, compile, run, load |

## Level 7 - Integration and Automation (files 70-77)

| File | Topic |
|------|-------|
| 70_rest_api_automation.md | Full REST API reference and automation |
| 71_building_analysis_scripts.md | Reusable analysis scripts in Python and JS |
| 72_web_ui_usage.md | Web interface panels and workflows |
| 73_express_integration.md | Integrating NeoDAX into Express servers |
...
| 77_fault_isolation.md | Fault isolation model — robust tools on top of NeoDAX |
...
| 84_glossary.md | Definitions of all technical terms used |
